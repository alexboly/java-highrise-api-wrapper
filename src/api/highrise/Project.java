 ...
 *
 */
public class Project extends HighriseEntity {
	 ...
	 */
	public Project(HRAuth auth, int projectId) {
	 ...
	 */
	public Project(HRAuth auth, String projectName) {
		super(auth);
	 ...
	 */
	Project(HRAuth auth, Element projectElement) {
