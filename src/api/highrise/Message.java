 ...
 *
 */
public class Message extends HighriseEntity {
	 ...
	 */
	public Message(HRAuth auth, int messageId) {
		super(auth);
	...
	Message(HRAuth auth, Element messageElement) {
		super(auth);
