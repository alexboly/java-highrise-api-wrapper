 ...
 *
 */
public class Comment extends HighriseEntity{
	 ...
	 */
	public Comment(HRAuth auth, int commentId) {
		super(auth);
	 ...
	 */
	public Comment(HRAuth auth, String resourceType, int resourceId, String body) {
		super(auth);
	 ...
	 */
	Comment(HRAuth auth, Element commentElement) {
		super(auth);
